    ...
    <div className="flex items-center justify-center min-h-screen p-4" style={{ background: theme.bg }}>
      <div className="w-full max-w-sm p-8 rounded-xl" style={{ background: theme.surface, border: `1px solid ${theme.muted}15` }}>
        <div className="text-center mb-8">
          ...
          <p className="font-body text-xl" style={{ color: theme.muted }}>Welcome back!</p>
        </div>
        ...
        <div className="text-center mt-6">
          <span className="font-body" style={{ color: theme.muted }}>New here? </span>
          <NavLink to="/register" className="font-body underline" style={{ color: theme.primary }}>
            Register
          </NavLink>
        </div>
      </div>
